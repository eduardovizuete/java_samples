...
import examples.reactive.webclient.controller.TweetWebController;
import examples.reactive.webclient.model.Tweet;
...
class WebControllerIntegrationTest {
    ...
    @Autowired
    private TweetWebController webController;
